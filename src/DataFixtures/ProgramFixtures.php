...
class ProgramFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    {
        $program = new Program();
        $program->setTitle('Chucky');
        $program->setSynopsis('Lorsqu\'une vieille poupée Chucky fait son apparition dans un vide-greniers de quartier, une paisible petite ville américaine se retrouve plongée en plein chaos, et une série de terribles meurtres commence à dévoiler les secrets des habitants.');
        $program->setCategory($this->getReference('category_Horreur'));
        $this->addReference('program_Chucky', $program);
        ...
        $program3->setCategory($this->getReference('category_Suspens'));
